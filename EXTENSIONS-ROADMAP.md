...
- [ ] ~~8. ComputedKit: 1 free baseline slot~~ **PARKED 2026-07-30** — corpus mining found zero demand for the Compare/drift job across 15,500 review texts (chrome-extension-market-scan/reports/computedkit-pro-drift-demand-mining-2026-07-30.md). Keep the $29 funnel live but stop leading with Baselines & Compare; the only paid-shaped ask in the corpus is a designed shareable artifact (brand sheet / token pack). Revisit only with real usage evidence
