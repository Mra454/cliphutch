/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: adab208173643bd8f91826a47b3e52ff)
// Runtime types generated with workerd@1.20260811.1 2026-08-18 nodejs_compat_v2
interface __BaseEnv_Env {
	...
	OUTBOUND_TIMEOUT_MS: string;
	MUTATION_JOURNAL_RETENTION_DAYS: string;
	REFUND_EVENT_RETENTION_DAYS: string;
	CLIPHUTCH_ALLOWED_ORIGINS: string;
	COMPUTEDKIT_ALLOWED_ORIGINS: string;
	CHECKOUT_ALLOWED_ORIGINS: string;
	CLIPHUTCH_STRIPE_PAYMENT_LINK_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "MAX_DEVICES_PER_LICENSE" | "COMPUTEDKIT_MAX_DEVICES_PER_LICENSE" | "OUTBOUND_TIMEOUT_MS" | "MUTATION_JOURNAL_RETENTION_DAYS" | "REFUND_EVENT_RETENTION_DAYS" | "CLIPHUTCH_ALLOWED_ORIGINS" | "COMPUTEDKIT_ALLOWED_ORIGINS" | "CHECKOUT_ALLOWED_ORIGINS" | "CLIPHUTCH_STRIPE_PAYMENT_LINK_ID" | "COMPUTEDKIT_STRIPE_PRICE_ID" | "COMPUTEDKIT_SUCCESS_URL" | "COMPUTEDKIT_CANCEL_URL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL">> {}
}
